...
Book.create({name: 'Lara',  user_id: 6})
Book.create({name: 'Bashair',  user_id: 7})
Book.create({name: 'Alaa',  user_id: 8})
Book.create({name: 'Jumana',  user_id: 9})
...
Page.create({name: 'Cover', number: "1", book_id: "46"})
Page.create({name: 'month one', number: "2", book_id: "47"})
...
Text.create({content: '3:44' page_id:1})
